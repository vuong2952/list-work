...
import DetailListWorkScreen from '../view/Screen/DetailListWorkScreen';
...
const TabNavigation = () => {
    return (
        <Tab.Navigator
            ...
            initialRouteName="ListWorkScreen">
            <Tab.Screen
                name="Home"
...
const Route = () => {
    ...
    return (
        ...
        <Stack.Navigator initialRouteName="Login">
            ...
            {/* <Stack.Screen name="DetailListWorkScreen" component={DetailListWorkScreen} options={{headerShown: false}}/>
